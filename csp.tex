...
\begin{definition}
    [provisional]
    A nontrivial finite algebra $\mathbf{A}$ is minimal iff every noncostant element of $\Pol_1(\mathbf{A})$ is a permutation.
\end{definition}
...
\begin{theorem}
    ...
    By this theorem among these there are exactly seven distinct clones on $2$ containing the constants operations.}.
\end{theorem}
