...
\begin{theorem}
    ...
    If $\mathbf{A}$ has trivial subalgebras, $\mathbf{A}$ is term-equivalent to the following: 
    \begin{enumerate}
        \item 
    \end{enumerate}
    If $\mathbf{A}$ has nontrivial subalgebras, $\mathbf{A}$ is term-equivalent to the following: 
    \begin{enumerate}
        \item 
    \end{enumerate}
\end{theorem}
